...
bool cVAOManager::LoadModelIntoVAO(std::string friendlyName, std::string fileName, sModelDrawInfo& drawInfo, unsigned int shaderProgramID, bool bIsDynamicBuffer)
{
    ...
    LoadModelIntoGPU(drawInfo, shaderProgramID, bIsDynamicBuffer);

    return true;
}

void cVAOManager::LoadModelIntoGPU(sModelDrawInfo& drawInfo, unsigned int shaderProgramID, bool bIsDynamicBuffer)
{
