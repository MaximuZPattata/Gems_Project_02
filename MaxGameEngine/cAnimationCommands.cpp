...
void cAnimationCommands::AddAnimation(std::string meshName, std::string animName, float frameRateIncrement, float animationDuration, float ticksPerSecond,
	cMesh* meshModel, sModelDrawInfo* modelInfo, AnimationInfo& animationToBePlayed, bool loopAnimation, bool isTwoBodyAnimation, bool isLowerBodyAnimation)
{
	...
	newAnimationInfo->bTwoBodyAnimation = isTwoBodyAnimation;
	newAnimationInfo->bLowerBodyAnimation = isLowerBodyAnimation;
